...
# =====================================================================
 ...
 set EMISpath  = $DATADIR/emis/gridded_area/gridded  ##   gridded emissions input directory
...
while ($TODAYJ <= $STOP_DAY )  #>Compare dates in terms of YYYYJJJ
   ...
   #setenv XJ_DATA $JVALpath/$JVALfile
    ...
    if ( $?DEBUG ) then
        ...
        ( /usr/bin/time -p /usr/lib64/mpich/bin/mpirun -np $NPROCS ${EXEC} ) |& tee buff_${EXECUTION_ID}.txt
        set err_status = ${status}      ##  save exit-status:  normal/success is 0, abnormal/failure non-zero
